...
public class ReviewController {
    ...
    @GetMapping("/reviews")
    public ResponseEntity<List<Review>> getAllReviewsById(@PathVariable Long companyId){
    ...
    public ResponseEntity<String> addReview(@PathVariable Long companyId,
        ...
        return new ResponseEntity<>("Review Not Saved, As Company Not Found", HttpStatus.NOT_FOUND);
    }
